...
- Hint 1.  
  ...
  개발 기간이 1년정도 되는 장기 프로젝트의 팀원이었는데 개발 과정 자체는 나쁘지않았지만, 그 결과가 크게 궁금하진 않았던 기억이 있다.
  반면 회사의 운영팀이 사용할 인트라넷 서비스의 불편함은 
...
- Hint 1.  
  ...
  중소기업을 주로 다녔기 때문에 백엔드, 프론트, 디비 모두 했어야 했는데 크게 호불호가 있지는 않았다. ~~깊게 몰라서일지도..~~  
